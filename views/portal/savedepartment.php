...
if (isset($_POST) & !empty($_POST)){
    ...
    if (2<=strlen($_POST['code']) & strlen($_POST['code'])<=7){

        $obj = new reg();
        $obj -> setdepartment($_POST)->storedepartment();
    }
    else{
        $_SESSION['error']= "Code Must be 2 to 7 length !";
    }
...
<div class="wrapper">
    ...
    <div class="sidebar" data-color="purple" data-image="assets/img/sidebar-1.jpg">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                <li style="background-color:#c4c6ca; color:black">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / Add Department
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-offset-2 col-xs-7 col-sm-7 " >
                        <?php if(isset($_SESSION['department'])){?><div class="btn-success" style="background-color:#388e3c;color: white; text-align: center; height: 30px; font-weight: bold; border-radius: 2px; border: 1px solid black" role="alert"> <?php echo  $_SESSION['department']; unset( $_SESSION['department']); ?> </div><?php } ?>
                        <?php if(isset( $_SESSION['error'])){?><div style="background-color:crimson;color: whitesmoke; text-align: center; height: 26px; border-radius: 2px;font-weight: bold; border: 1px solid black" role="alert"> <?php echo  $_SESSION['error']; unset( $_SESSION['error']);?> </div><?php } ?>
                        <br />
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title" style="text-align: center">Add Your University Department</h4>
                                    ...
                                    <form class="form-horizontal" method="post" >
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text"  name="code" placeholder=" Example 222" required> </td>

                                            </tr>
                                            <tr>
                                                <td>Department Name :</td>
                                                <td><input type="text"  name="name" placeholder=" Example CSE" required></td>
                                            </tr>
                                            </tbody>
                                        </table>

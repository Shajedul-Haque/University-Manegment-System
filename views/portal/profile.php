        ...
        <nav class="navbar navbar-transparent navbar-absolute">
            <div class="container-fluid">
                <div class="collapse navbar-collapse" style="background-color:darkcyan; color: white">
                    <p class="navbar-left"  style="color: white; font-weight: bold ; color:whitesmoke; margin-top:14px"> University Management System Portal  <a href="#" style="color: #3e2723">( Go Home )</a></p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-offset-2 col-xs-7 col-sm-7 " >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class=" col-md-9 col-lg-9 ">
                                            <table class="table table-user-information">
                                                ...
                                                <tr>
                                                    <td>Full Name </td>
                                                    <td><?php echo $_SESSION['user_id']['fullname'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Account Type</td>
                                                    <td>Admin</td>
                                                ...
                                                <tr>
                                                    <td>Username</td>
                                                    <td><?php echo $_SESSION['user_id']['username'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Email Address</td>
                                                    <td><?php echo $_SESSION['user_id']['email'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Mobile No</td>
                                                    <td><?php echo $_SESSION['user_id']['Mobile'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Created At</td>
                                                    <td><?php echo $_SESSION['user_id']['created_at'] ?></td>
                                                </tr>
                                                <tr>
                                                    <td>Updated At</td>
                                                    <td> <?php
                                                        if ($_SESSION['user_id']['updated_at']=='0000-00-00 00:00:00'){
                                                            echo " No Update";
                                                        }
                                                        else{
                                                            echo $_SESSION['user_id']['updated_at'];
                                                        }
                                                        ?></td>
                                                </tr>
                            ...
                            <a href="editprofile.php" data-original-title="Edit this user" data-toggle="tooltip"  class="btn  btn-warning"><i class="fa fa-fw fa-edit"></i> Edit</a>

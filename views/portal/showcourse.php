                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / All Courses
                                </li>
                            </ol>
                        </div>
                    </div>
            ...
            <div class="col-md-offset-1 col-md-10">
                <div class="card">
                    <div class="card-header" data-background-color="orange">
                        <h4 class="title" style="text-align: center">All Courses Of Your University</h4>
                    ...
                    <div class="card-content table-responsive">
                        <table class="table table-hover">
                            ...
                            foreach ($alldata as $data) {
                                ...
                                <tr>
                                    ...
                                    <td><center><?php echo $data['coursename'] ?></center></td>
                                    <td><?php echo $data['coursecode'] ?></td>
                                    <td><center><?php echo $data['coursecredit'] ?> </center></td>
                                    <td><center><?php echo $data['department'] ?> </center></td>
                                    <td><?php echo $data['semester'] ?></td>
                                    <td><small><?php echo $data['description'] ?></small></td>
                        ...
                        <div class="panel-footer">
                            ...
                            <span class="pull-right">
                                    <a href="addcourse.php" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-info">Add New Course</a>
                            </span>
                        </div>
                    </div>
                </div>

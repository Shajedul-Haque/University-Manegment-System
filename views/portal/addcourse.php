...
if (empty($_SESSION['user_id'])) {
    ...
    $allsemester=$obj->getallsemester();
}

            if (isset($_POST) & !empty($_POST)){

                    if ( !empty($_POST['credit']) & !empty($_POST['department']) & !empty($_POST['semester']) & !empty($_POST['description']) & 5<=strlen($_POST['coursecode']) & $_POST['credit']>0  & $_POST['credit']<=5 ){

                                $obj = new reg();
                                $obj->setcourse($_POST)->storecourse();
                    }
            else{
                $_SESSION['error']= "Code must be 5 characters And Credit less than 5.0 not 0.0";
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li style="background-color:#c4c6ca;">
                    <p style="padding-top:8px;color:black;font-weight:bold" id="course">
                        <span><i style="margin-left:28px;color:black;" class="material-icons">dashboard</i>
                        Courses</span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / Save Course
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title" style="text-align: center">Add Your University Course</h4>
                                ...
                                <div class="card-content table-responsive">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Credit</td>
                                                <td><input type="text" name="credit"  placeholder=" Course Credit" required></td>
                                            </tr>
                                            </tr>
                                            <tr>
                                                <td>Describtion</td>
                                            ...
                                            <tr>
                                                <td>Semester</td>
                                                <td><select name="semester" style="width: 78%;height: 25px" size="1">
                                                        <option value="">Select ..</option> <?php

    ...
    <div class="sidebar" data-color="purple" data-image="assets/img/sidebar-1.jpg">
        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li >
                    <a style="margin-top: 0%; padding-top: 2%;margin-left:10px;" href="courseassign.php">
                ...
                <a style="margin-top: 0%; padding-top: 0%;margin-left:10px;color:black;font-weight:bold" href="allocateclassroom.php">
                    <i  style="color:black;"class="material-icons">location_on</i>
                    <p>Allocate Classrooms</p>
                </a>
                </li>
                <li>
                    <a style="margin-top: 0%; padding-top: 0%;margin-left:10px" href="#">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / Allocate Class Room
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="green">
                                    <h4 class="title" style="text-align: center">Allocate Class Rooms</h4>
                                ...
                                <div class="card-content table-responsive">
                                    <form class="form-horizontal" method="post" >
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>Course Code</td>
                                                <td><select name='course_code' onchange="showOrNot()" id="course_code" style="width: 78%;height: 25px" size="1">
                                                        <option value="">Select Code</option>
                                                    </select></td>
                                            </tr>
                                            <tr>
                                                <td>Room No</td>
                                                <td><select  name="room" id="room" style="width: 78%;height: 25px" size="1">
                                                        <option value="">Select Code</option>
                                            ...
                                            <tr>
                                                <td>Day</td>
                                                <td><select  name="day" id="room" style="width: 78%;height: 25px" size="1">
                                                        <option value="">Select Code</option>
                            ...
                            <span style="margin-left:15%">
                                 <button type="submit" id="btn"  class="btn btn-info" ><i class="fa fa-check"></i>Allocate</button>
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    for( var i = 0; i<clen; i++){
                        var idd = response['course'][i]['coursecode'];

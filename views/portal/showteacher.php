                ...
                <div class="card">
                    ...
                    <div class="card-content table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php
                            foreach ($allteacher as $data) {

                                ?>

                                <tr>
                                    <td><?php echo $obj->i++; ?></td>
                                    <td><center><?php echo $data['teachername'] ?></center></td>
                                    <td><small><?php echo $data['address'] ?> </small></td>
                                    <td><center><?php echo $data['email'] ?> </center></td>
                                    <td><center><?php echo $data['contact_no'] ?> </center></td>
                                    <td><center><?php echo $data['designation'] ?> </center></td>
                                    <td><center><?php echo $data['department'] ?> </center></td>
                                    <td><center><?php echo $data['teachercredit'] ?></center></td>
                        ...
                        <div class="panel-footer">
                            ...
                            <span class="pull-right">
                                    <a href="addteacher.php" data-original-title="Remove this user" data-toggle="tooltip" type="button" class="btn btn-info">Add New Teacher</a>
                            </span>
                        </div>
                    </div>
                </div>

        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li style="background-color:#c4c6ca;">
                    <a style="margin-top: 0%; padding-top: 2%;margin-left:10px;color:black;font-weight:bold" href="enrollclass.php">
                        <i style="color:black;" class="material-icons">unarchive</i>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title" style="text-align: center">Enroll In a Course Of A Student</h4>
                            ...
                            <span style="margin-left:15%">
                                 <button type="submit" class="btn btn-primary" ><i class="fa fa-fw fa-floppy-o"></i> Enroll</button>
            ...
            $("#sel_st").change(function(){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        console.log(response['course_code']);
                        var clen = response['course_code'].length;
                        $("#course_code").empty();
                        $("#course_code").append("<option value=''>"+'Select Code'+ "</option>");
                        for( var i = 0; i<clen; i++){
                            var idd = response['course_code'][i]['coursecode'];
                            var code = response['course_code'][i]['coursecode'];

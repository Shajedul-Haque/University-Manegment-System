        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <li style="background-color:#c4c6ca;" >
                    <a style="margin-top: 0%; padding-top: 2%;margin-left:10px;color:black;font-weight:bold" href="registerstudent.php">
                        <i style="color:black;" class="material-icons">bubble_chart</i>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / Register A Student
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title" style="text-align: center">Add Your University Student</h4>
                                    <p class="category" style="text-align: center">Session, 2018</p>
                                </div>
                                <div class="card-content table-responsive">
                                    <form class="form-horizontal" method="post" action="student_show.php" >
                                        <table class="table table-hover">
                                            <thead class="text-warning">
                                            <tbody>
                                            <tr>
                                                <td>Full Name</td>
                                                <td><input type="text" name="fullname" placeholder=" Student Name" required> </td>
                                            ...
                                            <tr>
                                                <td>Contact No</td>
                                                <td><input type="number" name="cell_no" maxlength="11" placeholder=" Cell No" required></td>
                                            </tr>
                                            <tr>
                                                <td>Date</td>
                                            ...
                                            <tr>
                                                <td>Department</td>
                                                <td><select name="department_id" style="width: 78%;height: 25px" size="1">
                            ...
                            <span style="margin-left:15%">
                                 <button type="submit" class="btn btn-primary" ><i class="fa fa-fw fa-floppy-o"></i> Register</button>

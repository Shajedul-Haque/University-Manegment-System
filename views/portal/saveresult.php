...
if (isset($_POST) & !empty($_POST)){
    ...
    if (  !empty($_POST['student_id']) &  !empty($_POST['course_code']) &  !empty($_POST['grade'])) {

        $obj = new reg();
        $obj->set_result($_POST)->check_result();
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb">
                                <li class="active">
                                    <i class="fa fa-dashboard"></i> Dashboard / Save Student Result
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-offset-2 col-md-8">
                            <div class="card">
                                <div class="card-header" data-background-color="blue">
                                    <h4 class="title" style="text-align: center">Save Student Result</h4>
                                ...
                                <div class="card-content table-responsive">
                                    <form class="form-horizontal" method="post" >
                                        <table class="table table-hover">
                                            ...
                                            <tr>
                                                <td>Course Code</td>
                                                <td><select id="course_code" name="course_code" style="width: 78%;height: 25px" size="1">
                                                        <option value="">Select Code</option>
                                                    </select></td>
                                            </tr>
                                            <tr>
                                                <td>Grade</td>
                                                <td><select name="grade" style="width: 78%;height: 25px" size="1">
                            ...
                            <span style="margin-left:15%">
                                 <button type="submit" class="btn btn-primary" ><i class="fa fa-fw fa-floppy-o"></i> Save Result</button>
        ...
        $("#sel_st").change(function(){
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    document.getElementById('st_input1').value=na;
                    document.getElementById('st_input2').value=em;
                    document.getElementById('st_input3').value=response['name']['department_id'];


                    var clen = response['course_code'].length;
                    $("#course_code").empty();
                    $("#course_code").append("<option value=''>"+'Select Code'+ "</option>");
                    for( var i = 0; i<clen; i++){
                        var idd = response['course_code'][i]['course_code'];
                        var code = response['course_code'][i]['course_code'];

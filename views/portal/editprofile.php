                    ...
                    <div class="col-xs-offset-2 col-xs-7 col-sm-7 " >
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <h3 class="panel-title" style="text-align: center; color:black; font-weight: bold">Update Your Account Information</h3>
                            </div>
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-md-3 col-lg-3 " align="center"> <img alt="User Pic" src="assets/img/Cloud.jpg" style="height:150px; width: 150px" class="img-circle img-responsive"> </div>
                                    <div class=" col-md-9 col-lg-9 ">
                                        <form class="form-group" method="post" action="proupdate.php">
                                            <table class="table table-user-information">
                                                <tbody>
                                                <tr>
                                                    <td>Full Name </td>
                                                    <td><input name="fullname" type="text" class="form-control"  value="<?php echo $_SESSION['user_id']['fullname']; ?>" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Account Type</td>
                                                    <td>Admin</td>
                                                ...
                                                <tr>
                                                    <td>Username</td>
                                                    <td><input name="username" type="text" class="form-control" value="<?php echo $_SESSION['user_id']['username']; ?>" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Email Address</td>
                                                    <td><input name="email" type="text" class="form-control" value="<?php echo $_SESSION['user_id']['email']; ?>" required></td>
                                                </tr>
                                                <tr>
                                                    <td>Mobile No</td>
                                                    <td><input name="mobile" type="number" class="form-control" value="<?php echo $_SESSION['user_id']['Mobile']; ?>" required></td>
                                                </tr>
                                                <tr>
                                                    <td>New Password</td>
                                                    <td><input name="password" type="password" class="form-control" placeholder="New Password"></td>
                                                </tr>
                                                <tr>
                                                    <td style="color:red;">Note </td>
                                                    <td>If you are not change the password. Keep it empty.</td>
                                                </tr>
                                                <input name="id" type="hidden" value="<?php echo $_SESSION['user_id']['id']; ?>">
                                                <input name="lastpassword" type="hidden" value="<?php echo $_SESSION['user_id']['password']; ?>">
                            ...
                            <input data-original-title="Edit this user" data-toggle="tooltip" type="submit" class="btn btn-success" value="Save info">
